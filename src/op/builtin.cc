...
TVM_REGISTER_PASS_CONFIG_OPTION(kLayoutSolver, ffi::String);
TVM_REGISTER_PASS_CONFIG_OPTION(kLayoutSolverTimeoutMs, Integer);
TVM_REGISTER_PASS_CONFIG_OPTION(kLayoutSolverVerbose, Bool);
